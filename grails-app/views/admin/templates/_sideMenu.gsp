	...
	<div class="navbar navbar-default" role="navigation">
		...
		<div class="navbar-collapse collapse sidebar-navbar-collapse">
			<ul class="nav navbar-nav">
				<g:each in="${grailsApplication.config.admin.domains}" var="domain">
					<li class="${domain == params.domainClass ? 'active' : ''}">
						<admin:link controller="genericAdmin" namespace="admin" domain="${domain}">${domain}</admin:link>
					</li>
